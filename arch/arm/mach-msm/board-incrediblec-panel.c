...
static int samsung_oled_panel_unblank(struct msm_lcdc_panel_ops *ops)
{
	...
	gpio_set_value(INCREDIBLEC_GPIO_LCD_RST_N, 1);
	udelay(50);
	gpio_set_value(INCREDIBLEC_GPIO_LCD_RST_N, 0);
	udelay(20);
	gpio_set_value(INCREDIBLEC_GPIO_LCD_RST_N, 1);
	msleep(20);
...
static uint32_t sony_tft_display_on_gpio_table[] = {
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R1, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R2, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R3, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R4, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R5, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G0, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G1, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G2, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G3, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G4, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G5, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B1, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B2, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B3, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B4, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B5, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_PCLK, 1, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_VSYNC, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_HSYNC, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_DE, 1, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_SPI_CLK, 1, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_SPI_DO, 1, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_SPI_CSz, 1, GPIO_4MA),
};

static uint32_t sony_tft_display_off_gpio_table[] = {
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R1, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R2, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R3, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R4, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_R5, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G0, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G1, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G2, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G3, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G4, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_G5, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B1, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B2, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B3, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B4, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_B5, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_PCLK, 0, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_VSYNC, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_HSYNC, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_DE, 0, GPIO_8MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_SPI_CLK, 0, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_SPI_DO, 0, GPIO_4MA),
	LCM_GPIO_CFG(INCREDIBLEC_LCD_SPI_CSz, 0, GPIO_4MA),
};
...
int __init incrediblec_init_panel(void)
{
	...
	if (gpio_get_value(INCREDIBLEC_GPIO_LCD_ID0)) {
		pr_info("%s: tft panel\n", __func__);
		...
		if (gpio_get_value(INCREDIBLEC_GPIO_LCD_RST_N))
			tft_panel_on = 1;
